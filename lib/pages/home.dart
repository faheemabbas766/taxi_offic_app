                              ...
                              InkWell(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(RouteManager.startshiftpage);
                                },
                                child: SizedBox(
                                  width: RouteManager.width / 3.3,
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Navigator.of(context)
                                        .pushNamed(RouteManager.addBooking);
                                  },
                                  child: Stack(
                                    children: [
                                      Opacity(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              // SizedBox(
                                              //   width: RouteManager.width / 23,
                                              // ),
                                              Image.asset(
                                                "assets/whatsnews.png",
                                                fit: BoxFit.fill,
                                                height: 35,
                                                width: 35,
                                              ),
